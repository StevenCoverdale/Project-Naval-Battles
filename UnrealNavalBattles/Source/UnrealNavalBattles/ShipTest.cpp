...
AShipTest::AShipTest(FObjectInitializer const& ObjectInitializer)
...
bool AShipTest::Fire_Validate()
{
	return true;
}

void AShipTest::Fire_Implementation()
{

}

void AShipTest::Tick(float delta)
{
	Super::Tick(delta);
...
void AShipTest::GetMouseClickLocation(FVector loc)
{
...
void AShipTest::GetMouseClickLocationWithShift(FVector loc)
{
...
void AShipTest::Destination(float delta)
{
...
int AShipTest::GetHealth()
{
	return _health;
}
int AShipTest::GetMaxHealth()
{
	return _maxHealth;
}
UCapsuleComponent* AShipTest::GetCapsuleComponent()
{
	return NULL;
}


void AShipTest::SetTarget(AShipTest * target)
{
